...
public class AntColonyOptimizedScheduler extends CloudletSchedulerSpaceShared {

    private RouteDiscovery ref ;
    private HashMap<Integer,Integer>groupPriority ;
    ...
    public double cloudletSubmit(Cloudlet cloudlet, double fileTransferTime) {
        ...
        this.ref = RouteDiscovery.getInstance();
        this.groupPriority = ref.getPriorityMap();
